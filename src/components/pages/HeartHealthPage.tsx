...
import { HeartPulseIcon, ListChecksIcon, HeartCrackIcon, ShieldCheckIcon, ActivityIcon, CookingPotIcon, CigaretteIcon, WindIcon, BookHeartIcon, StethoscopeIcon } from '../Icons';
                    ...
                    <aside className="lg:col-span-1 space-y-6 sticky top-20">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100">
                           <h3 className="font-bold text-xl text-slate-800 mb-2">{t.diagnosis}</h3>
                            <p className="text-slate-600 text-sm mb-4">Diagnosis may involve blood pressure checks, blood tests (like a lipid panel), or an ECG. Our AI can help you understand your reports, but only a doctor can diagnose a condition.</p>
                            <button
